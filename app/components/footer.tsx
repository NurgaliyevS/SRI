      ...
      <div className="container mx-auto px-6 py-8">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/5 mb-6 md:mb-0">
            <h3 className="text-purple-800 text-lg font-semibold mb-2">TMolecule</h3>
          ...
          <div className="w-full md:w-1/5">
            ...
            <input type="email" placeholder="Enter your email" className="w-full px-3 py-2 text-gray-700 border border-neutral-200 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-600 dark:border-neutral-800" />
          </div>
          <div className="w-full md:w-1/5 mt-6 md:mt-0">
            <h4 className="text-gray-900 font-semibold mb-2">Follow Us</h4>
            <div className="flex space-x-4">
              <a href="https://facebook.com/GetTMolecule" target="https://facebook.com/GetTMolecule" rel="noopener noreferrer" className="text-gray-600 hover:text-blue-600">
                <Facebook size={24} />
              </a>
              <a href="https://instagram.com/tmolecule.official" target="https://www.instagram.com/tmolecule.official" rel="noopener noreferrer" className="text-gray-600 hover:text-pink-600">
                <Instagram size={24} />
              </a>
              <a href="https://tiktok.com/@tmolecule" target="https://www.tiktok.com/@tmolecule" rel="noopener noreferrer" className="text-gray-600 hover:text-black">
                <TikTok size={24} />
              </a>
            </div>
          </div>
